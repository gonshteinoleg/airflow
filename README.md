...
## Что дальше?
Синхронизация с репозиторием будет происходить автоматически, т.е. дальше вы просто складываете ваши даги в репозиторий и они почти сразу будут подтягиваться в папку dags.
